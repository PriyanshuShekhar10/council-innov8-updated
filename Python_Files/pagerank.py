...
df = pd.read_csv('/Users/acrymonic/Documents/Hackathons/adg332/final-dict-sorted-k2.csv')
    ...
    stylesheet=[
            {
                ...
                'style': {
                    ...
                    'width': 'mapData(pagerank, 0, 0.1, 50, 90)',  # Increase the node width
                    'height': 'mapData(pagerank, 0, 0.1, 50, 90)',  # Increase the node height
                    'border-width': 2,
                    'border-color': '#333',
